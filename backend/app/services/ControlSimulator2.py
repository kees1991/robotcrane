...
class ControlSimulator2(object):
    """Simulating the origin sensor signal and the control loop"""

    def __init__(self, moving_time: float, target_x: float, target_y: float, target_z: float, target_phi: float, max_vel: float, max_ang_vel: float):
